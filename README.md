...
1. **Study Setup**\ The number of decision time points and the randomization
probability, i.e. the probability of assigning the treatment at each decision
time point.

1. **Availability**\ Treatment can only be provided when an individual is
...
1. **Success Probability Null Curve**\ The Success Probability Null Curve at
...
1. **Proximal Treatment Effect**\ The Proximal Treatment Effect at each decision
